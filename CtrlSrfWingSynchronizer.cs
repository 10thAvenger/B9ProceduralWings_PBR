...
namespace B9PW_Technicolor
{
    ...
    {
        public List<WingProceduralShabby> connectedCtrlSrfWings;
        ...
        public static void AddSynchronizer(Part p, List<WingProceduralShabby> connectedCtrlSrfWings)
        {
            p.gameObject.AddComponent<CtrlSrfWingSynchronizer>().connectedCtrlSrfWings = connectedCtrlSrfWings;
        }
#if FAR
        public static void FARAddSynchronizer(Part p, List<WingProceduralShabby> connectedCtrlSrfWings)
        {
