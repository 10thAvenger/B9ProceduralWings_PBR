...
namespace B9PW_Technicolor
{
    ...
    public class WingProceduralShabby : PartModule, IPartCostModifier, IPartSizeModifier, IPartMassModifier
    {
        // Some handy bools
        [KSPField]
        ...
        [KSPField(isPersistant = true)]
        public bool moduleWasJustBorn = true;
        ...
        public MeshFilter meshFilterWingSurface1;
        public MeshFilter meshFilterWingSurface2;
        public MeshFilter meshFilterWingSurface1T;
        public MeshFilter meshFilterWingSurface2T;
        ...
        public MeshFilter meshFilterCtrlSurface1;
        public MeshFilter meshFilterCtrlSurface2;
        public MeshFilter meshFilterCtrlSurface1T;
        public MeshFilter meshFilterCtrlSurface2T;
        ...
        public static MeshReference meshReferenceWingSurface1;
        public static MeshReference meshReferenceWingSurface2;
        public static MeshReference meshReferenceWingSurface1T;
        public static MeshReference meshReferenceWingSurface2T;
        ...
        public static MeshReference meshReferenceCtrlSurface1;
        public static MeshReference meshReferenceCtrlSurface2;
        public static MeshReference meshReferenceCtrlSurface1T;
        public static MeshReference meshReferenceCtrlSurface2T;
        ...
        private void InheritanceStatusUpdate()
        {
            ...
            if (!part.parent.Modules.Contains<WingProceduralShabby>())
            {
                return;
            }

            WingProceduralShabby parentModule = FirstOfTypeOrDefault<WingProceduralShabby>(part.parent.Modules);
        ...
        private void InheritShape(WingProceduralShabby parent)
        {
        ...
        private void InheritBase(WingProceduralShabby parent)
        {
            if (parent.isCtrlSrf || isCtrlSrf)
                return;
        ...
        private void InheritEdges(WingProceduralShabby parent)
        {
            if (parent.isCtrlSrf || isCtrlSrf)
                return;
        ...
        private void InheritColours(WingProceduralShabby parent)
        {
        ...
        private void InheritCtrlOffset(WingProceduralShabby parent, bool back)
        {
            if (back)
            {
        ...
        public List<WingProceduralShabby> procws;
        ...
        public override void OnSave(ConfigNode node)
        {
            ...
            node.SetValue("name", "WingProcedural");    // for B9PW_PBR - Make module name on save file just like the original B9PW module
        }

        public override void OnLoad(ConfigNode node)
        {
            moduleName = "WingProceduralShabby";    // for B9PW_PBR - Change moduleName back to normal after loading from save file
        ...
        {
            if (part.parent != null && part.parent.Modules.Contains<WingProceduralShabby>())
            {
                WingProceduralShabby parentModule = FirstOfTypeOrDefault<WingProceduralShabby>(part.parent.Modules);
                if (parentModule != null)
                {
        ...
        public void OnEditorPartEvent(ConstructionEventType type, Part p)
        {
            if (isWingAsCtrlSrf)
            {
                if (type == ConstructionEventType.PartCopied || type == ConstructionEventType.PartPicked || type == ConstructionEventType.PartCreated || type == ConstructionEventType.PartDetached)
                    ...
                    {
                        var wproc = FirstOfTypeOrDefault<WingProceduralShabby>(p.Modules);
        ...
        public void FindConnectedCtrlSrfWings()
        {
            ...
            List<WingProceduralShabby> connectedCtrlSrfWings = new List<WingProceduralShabby>() { this };
            ...
            do
            {
                ...
                var wp = FirstOfTypeOrDefault<WingProceduralShabby>(ctrlSrfWingRoot.Modules);
            ...
            var childrenCtrlSrfWings = ctrlSrfWingParts
                    .Select(c => FirstOfTypeOrDefault<WingProceduralShabby>(c.Modules))
        ...
        public ModulePartVariants GetSurfVariantsModule()
        {
            List<ModulePartVariants> allModulesPartVariant = part.FindModulesImplementing<ModulePartVariants>();
            foreach (ModulePartVariants module in allModulesPartVariant)
            {
                List<PartVariant> variantsList = module.variantList;
                if (variantsList[1].Name == "TilesBottom" && variantsList[2].Name == "TilesTop")
                {
                    return module;
                }
            }

            Debug.Log("[B9PW_PBR] ERROR: Part has no compatible ModulePartVariants component!");
            return null;
        }
        ...
        public void UpdateGeometry(bool updateAerodynamics)
        {
            ...
            if (HighLogic.LoadedSceneIsEditor) DetermineUpSurface();
            SetUpDownSurfaceMeshes();
            ...
            if (!isCtrlSrf)
            {
                ...
                UpdateWingSurfaceGeometry(
                    meshFilterWingSurface1, meshReferenceWingSurface1,
                    wingThicknessDeviationRoot, wingThicknessDeviationTip,
                    wingWidthTipBasedOffsetTrailing, wingWidthTipBasedOffsetLeading,
                    wingWidthRoot, wingWidthRootBasedOffset,
                    geometricLength, geometricWidthTip, geometricWidthRoot, geometricOffsetTip);
                UpdateWingSurfaceGeometry(
                    meshFilterWingSurface2, meshReferenceWingSurface2,
                    wingThicknessDeviationRoot, wingThicknessDeviationTip,
                    wingWidthTipBasedOffsetTrailing, wingWidthTipBasedOffsetLeading,
                    wingWidthRoot, wingWidthRootBasedOffset,
                    geometricLength, geometricWidthTip, geometricWidthRoot, geometricOffsetTip);
                UpdateWingSurfaceGeometry(
                    meshFilterWingSurface1T, meshReferenceWingSurface1T,
                    wingThicknessDeviationRoot, wingThicknessDeviationTip,
                    wingWidthTipBasedOffsetTrailing, wingWidthTipBasedOffsetLeading,
                    wingWidthRoot, wingWidthRootBasedOffset,
                    geometricLength, geometricWidthTip, geometricWidthRoot, geometricOffsetTip);
                UpdateWingSurfaceGeometry(
                    meshFilterWingSurface2T, meshReferenceWingSurface2T,
                    wingThicknessDeviationRoot, wingThicknessDeviationTip,
                    wingWidthTipBasedOffsetTrailing, wingWidthTipBasedOffsetLeading,
                    wingWidthRoot, wingWidthRootBasedOffset,
                    geometricLength, geometricWidthTip, geometricWidthRoot, geometricOffsetTip);
            ...
            else
            {
                ...
                UpdateCtrlSrfSurfaceGeometry(
                    meshFilterCtrlSurface1, meshReferenceCtrlSurface1,
                    ctrlOffsetRootClamped, ctrlOffsetTipClamped,
                    ctrlThicknessDeviationRoot, ctrlThicknessDeviationTip,
                    ctrlEdgeWidthDeviationRoot, ctrlEdgeWidthDeviationTip,
                    ctrlTipWidth, ctrlRootWidth, geometricLength);
                UpdateCtrlSrfSurfaceGeometry(
                    meshFilterCtrlSurface2, meshReferenceCtrlSurface2,
                    ctrlOffsetRootClamped, ctrlOffsetTipClamped,
                    ctrlThicknessDeviationRoot, ctrlThicknessDeviationTip,
                    ctrlEdgeWidthDeviationRoot, ctrlEdgeWidthDeviationTip,
                    ctrlTipWidth, ctrlRootWidth, geometricLength);
                UpdateCtrlSrfSurfaceGeometry(
                    meshFilterCtrlSurface1T, meshReferenceCtrlSurface1T,
                    ctrlOffsetRootClamped, ctrlOffsetTipClamped,
                    ctrlThicknessDeviationRoot, ctrlThicknessDeviationTip,
                    ctrlEdgeWidthDeviationRoot, ctrlEdgeWidthDeviationTip,
                    ctrlTipWidth, ctrlRootWidth, geometricLength);
                UpdateCtrlSrfSurfaceGeometry(
                    meshFilterCtrlSurface2T, meshReferenceCtrlSurface2T,
                    ctrlOffsetRootClamped, ctrlOffsetTipClamped,
                    ctrlThicknessDeviationRoot, ctrlThicknessDeviationTip,
                    ctrlEdgeWidthDeviationRoot, ctrlEdgeWidthDeviationTip,
                    ctrlTipWidth, ctrlRootWidth, geometricLength);
        ...
        public void UpdateWingSurfaceGeometry(
            MeshFilter meshFilter, MeshReference meshReference,
            float wingThicknessDeviationRoot, float wingThicknessDeviationTip,
            float wingWidthTipBasedOffsetTrailing, float wingWidthTipBasedOffsetLeading,
            float wingWidthRoot, float wingWidthRootBasedOffset,
            float geometricLength, float geometricWidthTip, float geometricWidthRoot, float geometricOffsetTip)
        {
            if (meshFilter != null)
            {
                meshFilter.transform.localPosition = Vector3.zero;
                meshFilter.transform.localRotation = Quaternion.Euler(0f, 0f, 0f);
        ...
        public void UpdateCtrlSrfSurfaceGeometry(
            MeshFilter meshFilter, MeshReference meshReference,
            float ctrlOffsetRootClamped, float ctrlOffsetTipClamped,
            float ctrlThicknessDeviationRoot, float ctrlThicknessDeviationTip,
            float ctrlEdgeWidthDeviationRoot, float ctrlEdgeWidthDeviationTip,
            float ctrlTipWidth, float ctrlRootWidth, float geometricLength)
        {
            if (meshFilter != null)
            {
                int length = meshReference.vp.Length;
        ...
        public bool CheckSurfaceUpDownMode()
        {
            string currentVariant = modulePartVariantsSurfUpDown.SelectedVariant.Name;
            //Debug.Log("[B9PW_PBR] Current variant is " + currentVariant);
            int modeCached = surfaceUpDownMode;
            ...
            switch (currentVariant)
            {
                ...
                case "Tiles":
                    ...
                    break;
                default:
                    Debug.Log("[B9PW_PBR] ERROR: Somehow the tracked ModulePartVariants is completely wrong!");
                    Debug.Log("[B9PW_PBR] ERROR: currentVariant = " + currentVariant);
                    break;
            }
        ...
        public void DetermineUpSurface()    // Same method used by Procedural Wings (hence limited in the same way)
        {
            if (!isCtrlSrf)
            {
                surface1_is_up = (meshReferenceWingSurface1.vp[0].y > 0f ^ isMirrored);
            }
            else
            {
                surface1_is_up = (meshReferenceCtrlSurface1.vp[0].x > 0f);
            }

            //Debug.Log("[B9PW_PBR] surface1_is_up = " + surface1_is_up);
        }

        public void SetUpDownSurfaceMeshes()
        {
            if (!isCtrlSrf)
            {
                meshFilterWingSurface1.gameObject.SetActive(  (surface1_is_up && surfaceUpDownMode <= 1)     || (!surface1_is_up && surfaceUpDownMode % 2 == 0) );
                meshFilterWingSurface2.gameObject.SetActive(  (surface1_is_up && surfaceUpDownMode % 2 == 0) || (!surface1_is_up && surfaceUpDownMode <= 1) );
                meshFilterWingSurface1T.gameObject.SetActive( (surface1_is_up && surfaceUpDownMode >= 2)     || (!surface1_is_up && surfaceUpDownMode % 2 == 1) );
                meshFilterWingSurface2T.gameObject.SetActive( (surface1_is_up && surfaceUpDownMode % 2 == 1) || (!surface1_is_up && surfaceUpDownMode >= 2) );
            }
            else
            {
                meshFilterCtrlSurface1.gameObject.SetActive(  (surface1_is_up && surfaceUpDownMode <= 1)     || (!surface1_is_up && surfaceUpDownMode % 2 == 0) );
                meshFilterCtrlSurface2.gameObject.SetActive(  (surface1_is_up && surfaceUpDownMode % 2 == 0) || (!surface1_is_up && surfaceUpDownMode <= 1) );
                meshFilterCtrlSurface1T.gameObject.SetActive( (surface1_is_up && surfaceUpDownMode >= 2)     || (!surface1_is_up && surfaceUpDownMode % 2 == 1) );
                meshFilterCtrlSurface2T.gameObject.SetActive( (surface1_is_up && surfaceUpDownMode % 2 == 1) || (!surface1_is_up && surfaceUpDownMode >= 2) );
            }
        }
        ...
        public void UpdateCounterparts()
        {
            ...
            {
                WingProceduralShabby clone = FirstOfTypeOrDefault<WingProceduralShabby>(p.Modules);
        ...
        private void SetupMeshFilters()
        {
            ...
            else
            {
                ...
                meshFilterCtrlSurface2T = CheckMeshFilter(meshFilterCtrlSurface2T, "surface2Tiled");
                for (int i = 0; i < meshTypeCountEdgeCtrl; ++i)
                {
        ...
        public void SetupMeshReferences()
        {
            ...
            if (!isCtrlSrf)
            {
                bool shouldEvenBother = true;   // Should even bother to check if ALL references are PERFECTLY okay? - not if even ONE is null.
                shouldEvenBother &= meshReferenceWingSection != null && meshReferencesWingEdge[meshTypeCountEdgeWing - 1] != null;
                shouldEvenBother &= meshReferenceWingSurface1 != null && meshReferenceWingSurface2 != null
                                            && meshReferenceWingSurface1T != null && meshReferenceWingSurface2T != null;
                if (shouldEvenBother)   // Okay just maybe they are all good, let's check...
                {
                    bool badRefExists = (meshReferenceWingSection.vp.Length <= 0 || meshReferencesWingEdge[meshTypeCountEdgeWing - 1].vp.Length <= 0);
                    badRefExists |= (meshReferenceWingSurface1.vp.Length <= 0 || meshReferenceWingSurface2.vp.Length <= 0
                                            || meshReferenceWingSurface1T.vp.Length <= 0 || meshReferenceWingSurface2T.vp.Length <= 0);
                    required = badRefExists;    // required is always =true at this point so just...
                }
            }
            else
            {
                bool shouldEvenBother = true;
                shouldEvenBother &= meshReferenceCtrlFrame != null && meshReferencesCtrlEdge[meshTypeCountEdgeCtrl - 1] != null;
                shouldEvenBother &= meshReferenceCtrlSurface1 != null && meshReferenceCtrlSurface2 != null
                                            && meshReferenceCtrlSurface1T != null && meshReferenceCtrlSurface2T != null;
                if (shouldEvenBother)
                {
                    bool badRefExists = (meshReferenceCtrlFrame.vp.Length <= 0 || meshReferencesCtrlEdge[meshTypeCountEdgeCtrl - 1].vp.Length <= 0);
                    badRefExists |= (meshReferenceCtrlSurface1.vp.Length <= 0 || meshReferenceCtrlSurface2.vp.Length <= 0
                                            || meshReferenceCtrlSurface1T.vp.Length <= 0 || meshReferenceCtrlSurface2T.vp.Length <= 0);
                    required = badRefExists;
                }
            }
        ...
        private void SetupMeshReferencesFromScratch()
        {
            ...
            if (!isCtrlSrf)
            {
                ...
                meshReferenceWingSurface2T  = FillMeshRefererence(meshFilterWingSurface2T);
                for (int i = 0; i < meshTypeCountEdgeWing; ++i)
                {
            ...
            else
            {
                ...
                meshReferenceCtrlSurface2T  = FillMeshRefererence(meshFilterCtrlSurface2T);
                for (int i = 0; i < meshTypeCountEdgeCtrl; ++i)
                {
        ...
        public IEnumerator SetupReorderedForFlight()
        {
            ...
            if (!vesselList[vesselStatusIndex].isUpdated)
            {
                ...
                List<WingProceduralShabby> moduleList = new List<WingProceduralShabby>();
                ...
                {
                    if (vessel.parts[i].Modules.Contains<WingProceduralShabby>())
                    {
                        moduleList.Add(vessel.parts[i].Modules.GetModule<WingProceduralShabby>());
                    }
                }
        ...
        public void GatherChildrenCl()
        {
            ...
            WingProceduralShabby child = FirstOfTypeOrDefault<WingProceduralShabby>(p.Modules);
                if (child == null)
                {
                    continue;
                }
            ...
            if (part.parent != null && part.parent.Modules.Contains<WingProceduralShabby>())
            {
                FirstOfTypeOrDefault<WingProceduralShabby>(part.parent.Modules).GatherChildrenCl();
            }
        }
        ...
        */
        ...
        public void FuelTankTypeChanged()
        {
            ...
            WingProceduralShabby wing = FirstOfTypeOrDefault<WingProceduralShabby>(p.Modules);
                if (wing != null)
                {
